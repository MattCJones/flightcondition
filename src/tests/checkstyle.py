...
print("="*60)
check_format("../flightcondition/atmosphere/atmosphere.py")
check_format("../flightcondition/flightcondition/flightcondition.py")
check_format("../flightcondition/units/units.py")
check_format("../flightcondition/constants/constants.py")
