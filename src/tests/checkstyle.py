...
print("="*60)
check_format("../flightcondition/atmosphere.py")
check_format("../flightcondition/flightcondition.py")
check_format("../flightcondition/units.py")
check_format("../flightcondition/constants.py")
